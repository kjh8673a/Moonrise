  ...
  return (
    <div className='grid w-full grid-cols-3 my-8 main-nav'>
        ...
        <div className="relative col-span-1">
            ...
            <input type="text" id="party-search" onChange={keywordHandler} onKeyPress={handleOnKeyPress} className="block w-full h-10 pl-10 text-sm text-white bg-transparent border border-gray-400 rounded-full focus:ring-white focus:border-white dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="다른 영화도 검색해보세요!"/>
        </div>
