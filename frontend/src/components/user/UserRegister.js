...
function UserRegister() {
    ...
    const getButtons = () => {
        ...
        <div key={index} className="flex items-center col-span-1 py-2 pl-3 transition-all rounded-lg hover:bg-white hover:bg-opacity-25">
            <input id={"check"+index} onChange={checkHandler} type="checkbox" value={genre} className="w-5 h-5 transition-all bg-gray-100 border-gray-300 rounded-lg accent-orange-400 "/>
                    ...
                    <div className='mx-10 my-5 text-left'>
                        ...
                        <div className='grid grid-cols-2 mt-4'>
                            <div className="flex items-center col-span-1 my-4 ml-3 transition-all rounded-lg hover:bg-white hover:bg-opacity-25">
                                <input id="gender-radio-1" onChange={genderHandler} type="radio" value="M" name="gender-radio" className="w-4 h-4 bg-gray-100 border-gray-300 accent-orange-400 "/>
                                <label htmlFor="gender-radio-1" className="ml-2 text-sm text-white">남</label>
                            </div>
                            <div className="flex items-center col-span-1 my-4 ml-3 transition-all rounded-lg hover:bg-white hover:bg-opacity-25">
                                <input id="gender-radio-2" onChange={genderHandler} type="radio" value="W" name="gender-radio" className="w-4 h-4 bg-gray-100 border-gray-300 accent-orange-400 "/>
                                <label htmlFor="gender-radio-2" className="ml-2 text-sm text-white">여</label>
                            </div>
                        </div>
                    </div>
                    <div className='mx-10 my-5 text-left'>
