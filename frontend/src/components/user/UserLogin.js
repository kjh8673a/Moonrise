...
function UserLogin() {
  ...
  return (
    <div className='userLogin grid grid-cols-3 h-full content-center bg-black bg-opacity-60'>
        <div  className="col-span-3 text-center duration-300">
            ...
            <button onClick={goRegister} className='m-3 text-center rounded-lg py-3 px-6 bg-kakao-bg text-kakao-text hover:opacity-80 transition-all duration-300'>
