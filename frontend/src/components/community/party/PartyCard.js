      ...
      <img src={CardImg} className="object-cover w-full h-36" alt="뒷풀이 카드 이미지"/>
        <div className="px-2 py-2 bg-orange-500">
          ...
          <div className="flex">
            ...
            <p className="w-2/6 ml-2 text-sm text-center">{props.partyDate}</p>
            ...
            <p className="w-2/6 ml-2 text-sm text-center">{props.partyPeople}명</p>
          </div>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
            ...
            <p className="ml-2 text-sm text-center w-44">서울시 종로구</p>
          </div>
        </div>
        {/* <div className="flex px-2 py-2">
          <p className="flex-1 text-sm text-center ">#소통</p> 
          <p className="flex-1 text-sm text-center ">#사진</p>
          <p className="flex-1 text-sm text-center">#덕질</p>
        </div> */}
    </div>
  )
}
