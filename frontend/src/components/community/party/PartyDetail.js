    ...
    <div className='PartyDetail mx-60 py-10 grid grid-cols-2 gap-4'>
      ...
      <div className="col-span-1">
        <div className="partyComment">
          ...
          <p className='px-2 py-2'>준비물이 따로 있을까요?</p>          
          <div className="flex items-center px-2 py-2">
            <div >
              <p className='text-xs'>익명</p>
              <input id="checked-checkbox" type="checkbox" value="" class="m-1 w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded focus:ring-orange-600"/>
            </div>
            <textarea id="chat" rows="1" className="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="문의사항을 남겨주세요"></textarea>
            <button type="submit" className="inline-flex justify-center ml-4 text-orange-600 rounded-full cursor-pointer hover:bg-orange-100 dark:text-orange-500 dark:hover:bg-gray-600">
