            ...
            <div className="grid grid-cols-2">
                ...
                <div className="col-span-1">
                    ...
                    <div className='relative m-4'>
                        ...
                        <textarea onChange={contentChangeHandler} className="block mt-4 py-2.5 px-2 h-64 w-full resize-none text-sm text-gray-300 bg-transparent border-2 rounded-lg border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-orange-300 peer" placeholder="" />
                    </div>
                </div>              
            </div>
