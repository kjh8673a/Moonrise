...
- 카카오 소셜 로그인
- 회원정보 수정
<img src="./docs/gif/로그인.gif">

### 영화 검색
- 달뜸의 시작페이지
- 보고 온 영화를 검색할 수 있다.
<img src="./docs/gif/영화검색.gif">
